...
__global__ void get_dst(float *dst, float *x, float *y,float *mu_x, float *y){
...
__global__ void recenter_step1(float *sum_x, float *sum_y, int *n, int *ny, float *x, float *y, int *group, int n){
...
void kmeans(int nreps, int n, int k,
            float *x_d, float *y_d, float *mu_x_d, float *mu_y_d,int *group_d,int *nx_d,float *sum_x_d, float *sum_y_d, float *dst_d){
